...
from backend.lnd.implementations import NewAddressQuery
...
def test_new_address(monkeypatch: MonkeyPatch):
    ...
    query = NewAddressQuery()
    ret = query.resolve_ln_new_address(resolve_info, address_type)
