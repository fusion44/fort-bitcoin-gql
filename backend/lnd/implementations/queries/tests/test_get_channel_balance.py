...
from backend.lnd.implementations import GetChannelBalanceQuery
...
def test_get_channel_balance(monkeypatch: MonkeyPatch):
    """
    ...
    query = GetChannelBalanceQuery()
    ret = query.resolve_ln_get_channel_balance(resolve_info)
